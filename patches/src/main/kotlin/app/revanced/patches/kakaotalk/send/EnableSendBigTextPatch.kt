...
val enableSendBigTextPatch = bytecodePatch(
    ...
    use = false // Starting from 25.10.0, the Quiet Send feature has been added, causing conflicts with the entry point for that feature. Therefore, it is disabled by default
) {
